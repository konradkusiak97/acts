...
void createSeedsForGroupSycl(
  ...
  try {
    ...
    if (!device_resource) {
        ...
        auto prefixEventBottom = q->submit([&](cl::sycl::handler& h) {
        ...
        auto prefixEventTop = q->submit([&](cl::sycl::handler& h) {
        ...
        prefixEventBottom.wait_and_throw();
        prefixEventTop.wait_and_throw();
        // sync
